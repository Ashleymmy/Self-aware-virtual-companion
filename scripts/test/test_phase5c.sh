...
for file in \
  "packages/core/agents/vibe-coder.yaml" \
  "packages/core/orchestrator/router.mjs" \
  "packages/core/orchestrator/vibe-coder.mjs" \
...
import { runVibeCodingTask } from './packages/core/orchestrator/vibe-coder.mjs';

const raw = await fs.readFile('packages/core/agents/vibe-coder.yaml', 'utf8');
