...
cd "${REPO_ROOT}"
RUNTIME_SCRIPT="${REPO_ROOT}/scripts/runtime/proactive_runtime.mjs"
DAEMON_SCRIPT="${REPO_ROOT}/scripts/runtime/proactive_daemon.mjs"
DISPATCH_SCRIPT="${REPO_ROOT}/scripts/runtime/proactive_dispatcher.mjs"
...
# 0) Required files
require_file "scripts/runtime/proactive_runtime.mjs"
require_file "scripts/runtime/proactive_daemon.mjs"
require_file "scripts/runtime/proactive_dispatcher.mjs"
require_file "scripts/lifecycle/phase2_run_once.sh"
require_file "scripts/lifecycle/phase2_cron_install.sh"
require_file "scripts/lifecycle/phase2_cron_remove.sh"
...
# 7) Real API smoke (default warn when env missing; opt into strict mode explicitly)
strict_live="${PHASE2_LIVE_STRICT:-0}"
missing=0
