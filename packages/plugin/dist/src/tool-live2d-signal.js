...
export function createLive2DSignalTool(api, _toolCtx, deps = {}) {
    return {
        name: "savc_live2d_signal",
        description: "Build structured Live2D signal payloads (emotion/expression/lipsync/interaction).",
        parameters: Type.Object({
            source: Type.Optional(Type.Union([Type.Literal("text"), Type.Literal("voice"), Type.Literal("interaction")], {
            ...
            interactionType: Type.Optional(Type.String({
        ...
        async execute(_toolCallId, params) {
            ...
            try {
                const live2dModule = deps.buildLive2DSignal || deps.buildLive2DPlan
                    ? {
